    ...
    >
        ...
        <div class=" bg-butterscotch bg-opacity-30">
            ...
            <div class="p-6 px-8 text-lg">
                STEMS will be conducted on <span class="font-semibold">4<sup>th</sup></span> (Maths)
                , <span class="font-semibold">9<sup>th</sup> Morning </span> (CS), <span class="font-semibold">9<sup>th</sup> Evening</span> (Probability-Statistics) and <span class="font-semibold">10<sup>th</sup> Evening </span> (Physics)
