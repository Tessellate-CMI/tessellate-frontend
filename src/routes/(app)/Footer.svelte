<footer class="footer border-t border-base-300  px-10 py-4 text-base-content bg-black">
    ...
    <div class="justify-self-center sm:justify-self-end">
        <div class="grid grid-flow-col gap-3">
            <a href="https://www.instagram.com/tessellate_cmi">
                <svg
            ...
            <a href="https://twitter.com/cmitessellate"
                ><svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
                ...
                ></a
            >
            <a href="https://www.youtube.com/TessellateCMI"
                ><svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
                ...
                ></a
            >
            <a href="https://www.facebook.com/CMITessellate"
                ><svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
